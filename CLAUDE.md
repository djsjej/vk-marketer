...
- [x] Шаг 2: авто-сетка тестов (`/launch_auto` — бот сам решает число тестов)
- [x] Шаг 3: авто-стоп дорогих по CPL кампаний (Сторож сам выключает)
- [x] Шаг 4: самообучение (Сторож пишет в базу знаний → итоги/новый раунд)
- [x] Боба — единая дверь с командой (руки: Кирилл/Тимур/Алина), меню Telegram
      упрощено (всё через Бобу). Финальный запуск денег — через подтверждение.
...
## ⚠️ Жёсткое правило ответов (просьба Vizit'а)

**КАЖДЫЙ ответ Vizit'у заканчивается явным блоком «что тебе сделать сейчас».**
Коротко, по шагам, для мобилы (он почти всегда с телефона). Если делать
ничего не надо — так и пишу прямо: «сейчас от тебя ничего, жду X». Vizit
не должен догадываться, какой его следующий шаг — я всегда говорю явно.
